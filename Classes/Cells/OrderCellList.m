...
{
    [super setPrice2:newPrice];
    lblPrice2.text=newPrice;
    lblPrice2.font=[UIFont fontWithName:@"Century Gothic" size:20];
}
-(void)setSrl:(NSString *)newSrl
{
    [super setSrl:newSrl];
    lblSrl.text=newSrl;
    lblSrl.font=[UIFont fontWithName:@"Century Gothic" size:20];
}
