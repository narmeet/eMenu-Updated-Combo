...
typedef enum {
    ...
    ProgressBarModeIndeterminate,
    /** Progress is shown using a MBRoundProgressView. */
	ProgressBarModeDeterminate,
	/** Shows a custom view */
	ProgressBarModeCustomView
} ProgressBarMode;

typedef enum {
    /** Opacity animation */
    ProgressBarAnimationFade,
    /** Opacity + scale animation */
    ProgressBarAnimationZoom
} ProgressBarAnimation;

@interface ProgressBar : UIView {
	
	ProgressBarMode mode;
    ProgressBarAnimation animationType;
	...
	id<ProgressBarDelegate> __weak delegate;
	NSString *labelText;
 ...
 */
+ (ProgressBar *)showHUDAddedTo:(UIView *)view animated:(BOOL)animated;
...
/**
 * The UIView (i.g., a UIIMageView) to be shown when the HUD is in ProgressBarModeCustomView.
...
/** 
 * ProgressBar operation mode. Switches between indeterminate (ProgressBarModeIndeterminate) and determinate
 * progress (ProgressBarModeDeterminate). The default is ProgressBarModeIndeterminate.
 *
 * @see ProgressBarMode
 */
@property (assign) ProgressBarMode mode;

/**
 * The animation type that should be used when the HUD is shown and hidden. 
 *
 * @see ProgressBarAnimation
 */
@property (assign) ProgressBarAnimation animationType;

/** 
 * The HUD delegate object. If set the delegate will receive hudWasHidden callbacks when the HUD was hidden. The
 * delegate should conform to the ProgressBarDelegate protocol and implement the hudWasHidden method. The delegate
 * object will not be retained.
 */
@property (weak) id<ProgressBarDelegate> delegate;
 ...
 */
- (void)hudWasHidden:(ProgressBar *)hud;
