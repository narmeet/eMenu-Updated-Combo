...
@interface TabSquareComboScroller ()
...
NSComparisonResult compareViewDepth(UIView *view1, UIView *view2, TabSquareComboScroller *self);

@end


@implementation TabSquareComboScroller
