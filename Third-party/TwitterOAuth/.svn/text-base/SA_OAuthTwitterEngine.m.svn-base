...
- (NSURLRequest *) authorizeURLRequest {
	...
	[request setParameters: @[[[OARequestParameter alloc] initWithName: @"oauth_token" value: _requestToken.key]]];	
	return request;
}
                        ...
                        responseType:(MGTwitterResponseType)responseType
{
    ...
    if (requestType != MGTwitterUpdateSendRequest && requestType != MGTwitterAccountRequest && requestType != MGTwitterFavoritesEnableRequest )
        if (params.count > 0) 
        {
...
- (NSString *)_cancelingTheRequestDone
{
...
- (void) response:(id)response connectionIdentifier:(NSString *)identifier
{
    [_delegate responseOfTwt:response requestIdentifier:identifier];
