...
{
 //identifier   
//    DLog(@"Parsing complete: %@  \n\nCount : %i", parsedObjects,[parsedObjects count]);
    [delegate response:parsedObjects connectionIdentifier:identifier];
  
/*    
    NSDictionary *data = [parsedObjects objectAtIndex:0];
    NSDictionary *status = [data objectForKey:@"status"];
    NSString *source     = [status objectForKey:@"source"];
    ...
    NSDictionary *data1 = [parsedObjects objectAtIndex:1];
*/    
